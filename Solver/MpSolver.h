...
#if (DEBUG || _DEBUG) || !(NDEBUG || _NDEBUG || RELEASE || _RELEASE)
...
#pragma comment(lib, RESOLVED_STRINGIFY(RESOLVED_CONCAT3(GUROBI_DIR, gurobi_c++, LINK_TYPE, VISUAL_STUDIO_VERSION)))
